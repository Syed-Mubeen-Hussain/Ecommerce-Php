                                            ...
                                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                                ...
                                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                                    <ul class="navbar-nav mr-auto">
                                                            ...
                                                            align-items: center;
                                                            text-align: center;" class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" style="    padding-top: 0;
                                                            padding-left: 0px;
                                                            padding-bottom: 0px;" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Hi <span class="text-primary"><?php echo $_SESSION['USER_NAME'] ?></span>
                                                            </a>
                                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                                <a class="dropdown-item no_arrow" href="my_order.php">Order</a>
                                                                <a class="dropdown-item no_arrow" href="profile.php">Profile</a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item no_arrow" href="logout.php">Logout</a>
                                                            </div>
                                                        </li>
