...
$category_name = mysqli_fetch_assoc(mysqli_query($con,"select * from categories where id = '$cat_id'"));
                ...
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        <nav class="bradcaump-inner">
                            ...
                            <span class="breadcrumb-item active"><?php echo $category_name['categories']?></span>
                        </nav>
                    </div>
                </div>
            </div>
