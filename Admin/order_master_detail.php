                        ...
                        <div class="table-stats order-table ov-h">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $totalPrice = 0;
                                    $res = mysqli_query($con, "select distinct(order_detail.id), order_detail.*,product.name,product.image,`order`.address,`order`.city,`order`.pincode from order_detail,product,`order` where order_id = '$order_id' and product.id = order_detail.product_id");
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td>Coupon Value</td>
                                        <td><?php echo $coupon_value."($coupon_code)" ?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"></td>
                                        <td>Total Price</td>
