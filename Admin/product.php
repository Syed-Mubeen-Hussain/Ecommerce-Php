...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == "status") {
        ...
        $update_sql = "update product set status = '$status' where id = '$id' $condition1";
...
$sql = "select product.*,categories.categories from product,categories where product.categories_id = categories.id $condition order by id desc";
