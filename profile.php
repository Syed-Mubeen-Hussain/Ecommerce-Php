						...
						<div class="col-xs-12">
							<form method="post" id="frmPassword">
								<div class="single-contact-form">
									...
									<div class="contact-box name">
										<input type="text" name="current_password" id="current_password" style="width:100%">
									</div>
								...
								<div class="single-contact-form">
									...
									<div class="contact-box name">
										<input type="text" name="new_password" id="new_password" style="width:100%">
									</div>
								...
								<div class="single-contact-form">
									...
									<div class="contact-box name">
										<input type="text" name="confirm_new_password" id="confirm_new_password" style="width:100%">
									</div>
									<span class="field_error" id="confirm_new_password_error"></span>
								</div>

								<div class="contact-btn">
									<button type="button" class="fv-btn" onclick="update_password()" id="btn_submit">Update</button>
